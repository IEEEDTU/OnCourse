...
function _init()
{
    ...
    $.AdminLTE.layout={
        ...
        $.AdminLTE.controlSidebar={
            ...
            _fix:function(a){
                var b=this;$("body").hasClass("layout-boxed")?(a.css("position","absolute"),
            ...
            _fixForFixed:function(a){
                a.css({position:"fixed","max-height":"100%",
        ...
        $.AdminLTE.boxWidget={selectors:$.AdminLTE.options.boxWidgetOptions.boxWidgetSelectors,icons:$.AdminLTE.options.boxWidgetOptions.boxWidgetIcons,animationSpeed:$.AdminLTE.options.animationSpeed,
        activate:function(a){
            var b=this;a||(a=document),$(a).on("click",b.selectors.collapse,
            function(a){
...
$.AdminLTE.options={
    ...
    controlSidebarOptions:{toggleBtnSelector:"[data-toggle='control-sidebar']",
...
function(a){
    ...
    a.fn.todolist=function(b){
        var c=a.extend({onCheck:function(a){return a},
        onUncheck:function(a){return a}},b);
        return this.each(function(){
