...
// Mailbox Widget ------------------------
app.directive('mailboxWidget', function(){
	return {
		restrict: 'E',
		templateUrl: 'mailbox-widget.html'
	};
});
...
// Announcement Widget ------------------------
app.directive('announcementWidget', function(){
	return {
		restrict: 'E',
		templateUrl: 'announcement-widget.html'
	};
});
